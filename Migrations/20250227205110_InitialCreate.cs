        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentRate = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assets_Renters_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OccupancyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AssetId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OccupancyHistories", x => x.OccupancyId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_OccupancyHistories_Renters_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Renters",
                        principalColumn: "RenterId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HistoryRentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AssetId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentChanges", x => x.HistoryRentId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OccupancyHistories_AssetId_Start",
                table: "OccupancyHistories",
                columns: new[] { "AssetId", "Start" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OccupancyHistories_CustomerId",
                table: "OccupancyHistories",
                column: "CustomerId");
